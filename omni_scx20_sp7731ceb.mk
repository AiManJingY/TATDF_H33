...
# Inherit from scx20_sp7731ceb device
$(call inherit-product, device/sprd/scx20_sp7731ceb/device.mk)

PRODUCT_DEVICE := scx20_sp7731ceb
PRODUCT_NAME := omni_scx20_sp7731ceb
PRODUCT_BRAND := SPRD
